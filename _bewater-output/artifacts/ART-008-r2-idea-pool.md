...
- opportunity_area_id: OA-001
  ...
  shortlist:
    ...
    - CS-009
    - CS-011
    confirmed: [CS-001, CS-002, CS-003, CS-004, CS-005, CS-006, CS-007, CS-008, CS-010]
- opportunity_area_id: OA-002
  ...
  shortlist:
    ...
    - CS-021
    - CS-022
    confirmed: [CS-012, CS-013, CS-014, CS-015, CS-016, CS-017, CS-018, CS-019, CS-020]
- opportunity_area_id: OA-003
  ...
  shortlist:
    recommended:
    - CS-030
    confirmed: [CS-023, CS-024, CS-025, CS-026, CS-027, CS-028, CS-029, CS-031, CS-032, CS-033]
decisions:
- type: confirm-shortlist
  opportunity_area_id: OA-001
  seed_ids: [CS-001, CS-002, CS-003, CS-004, CS-005, CS-006, CS-007, CS-008, CS-010]
  decided_by:
    name: 秋南Dylan
    role: product-owner
    type: human
- type: confirm-shortlist
  opportunity_area_id: OA-002
  seed_ids: [CS-012, CS-013, CS-014, CS-015, CS-016, CS-017, CS-018, CS-019, CS-020]
  decided_by:
    name: 秋南Dylan
    role: product-owner
    type: human
- type: confirm-shortlist
  opportunity_area_id: OA-003
  seed_ids: [CS-023, CS-024, CS-025, CS-026, CS-027, CS-028, CS-029, CS-031, CS-032, CS-033]
  decided_by:
    name: 秋南Dylan
    role: product-owner
    type: human
...
stage: ideate
revision: 2
supersedes_ref: artifact:ART-008@1
...
确认记录（r2）：秋南Dylan（product-owner）于 2026-08-17 人工确认短名单——接受全部推荐砍除（CS-009/011/021/022/030），4 条 partial 种子（CS-010/017/020/032）按"拿不准就保留"全部保留。确认后每条保留种子全部进入 bw-concept-development 的概念发展（无草稿中间层）。
