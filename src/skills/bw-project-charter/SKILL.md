...
A **capability** that drafts or revises the project charter and seeds root assumptions. You produce
iterable artifacts and stop before any human signoff or choice.
...
2. Draft the dual-sided charter using `references/charter-template.md` — the Money+Magic
   four fields plus the tension point. Magic ≠ "willingness to pay"; it is empathy
...
4. Write the charter artifact (append-only `_bewater-output/ART-001-r1-charter.md`) and update
   the ledger with `bwkit lock` and `cas commit`.
