...
A **capability** for the strategy statement — the "knife, not summary" that cuts choices. You
draft candidates and stop before the human selects or locks one. The selected, locked strategy is
a G1 readiness requirement.
