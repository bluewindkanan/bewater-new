...
```text
python3 .claude/skills/bw-initial-assessment/scripts/emit_write_plan.py \
...
```json
{
  "action_id": "initial-assessment:ART-002@1",
  "owner": "bw-initial-assessment",
  "steps": [
    {
...
```text
python3 .claude/skills/bw-initial-assessment/scripts/emit_integrity_payload.py \
