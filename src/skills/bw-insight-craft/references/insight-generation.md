...
and opens new opportunity). Accepted Beliefs are the insight's target. Directional hypotheses
belong to Define, after the Insight Portfolio has human F/P/E/T signoff.
...
- **Code Cracking** — assume the pearls are true; list 3–5 explanatory hypotheses
  (motivation / culture / system / market) for the tensest pearl. These are interpretation aids,
  not a directional hypothesis or directional-hypothesis artifact.
