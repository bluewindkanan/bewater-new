...
def build_parser() -> argparse.ArgumentParser:
    ...
    lp.add_argument("--layer", required=True, choices=["root", "strategy", "opportunity", "concept", "feature"])
    ...
    lp.add_argument("--validation-status", default="open", dest="validation_status")
    lp.add_argument("--status", default="active")
    ...
    lp.add_argument("--layer", choices=["root", "strategy", "opportunity", "concept", "feature"])
    ...
    lp.add_argument("--validation-status", dest="validation_status")
...
def _cmd_ledger(args) -> int:
    ...
    if args.ledger_cmd == "add":
        ...
        print(f"bw ledger add: {a.id}  {a.statement}  (layer={a.layer.value}, branch={a.branch})")
        return 0
...
def _cmd_gate_scan(args) -> int:
    ...
    try:
        ...
        print(f"bw gate-scan: {args.gate} not yet implemented (only G1)")
        return 2
